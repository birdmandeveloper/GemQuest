...
public class AssetManager {
    ...
    public void setMonsters() {
        ...
        //  if (monSpawnZero[5]) {
        //     gamePanel.getMonsters()[map][6] = new MON_GreenSlime(gamePanel, 6);
        //      gamePanel.getMonsters()[map][6].setWorldX(tileSize * 42);
        //     gamePanel.getMonsters()[map][6].setWorldY(tileSize * 19);
        //       gamePanel.getMonsters()[map][6].setIndex(6);
        //     }

        //  if (monSpawnZero[5]) {
        //    gamePanel.getMonsters()[map][7] = new MON_GreenSlime(gamePanel, 7);
        //  gamePanel.getMonsters()[map][7].setWorldX(tileSize * 43);
        //gamePanel.getMonsters()[map][7].setWorldY(tileSize * 35);
        //  gamePanel.getMonsters()[map][7].setIndex(7);
        //}
        //if (monSpawnZero[5]) {
        //  gamePanel.getMonsters()[map][8] = new MON_EggSlime(gamePanel, 8);
        //gamePanel.getMonsters()[map][8].setWorldX(tileSize * 44);
        //gamePanel.getMonsters()[map][8].setWorldY(tileSize * 33);
        //gamePanel.getMonsters()[map][8].setIndex(8);
        //}
        //if (monSpawnZero[5]) {
        //  gamePanel.getMonsters()[map][9] = new MON_RedSlime(gamePanel, 9);
        // gamePanel.getMonsters()[map][9].setWorldX(tileSize * 41);
        //  gamePanel.getMonsters()[map][9].setWorldY(tileSize * 38);
        //   gamePanel.getMonsters()[map][9].setIndex(9);
        //   }
        //     if (monSpawnZero[5]) {
        //  gamePanel.getMonsters()[map][10] = new MON_GreenSlime(gamePanel, 10);
        // gamePanel.getMonsters()[map][10].setWorldX(tileSize * 48);
        //  gamePanel.getMonsters()[map][10].setWorldY(tileSize * 42);
        //    gamePanel.getMonsters()[map][10].setIndex(10);
        //   }
        //     if (monSpawnZero[5]) {
        //       gamePanel.getMonsters()[map][11] = new MON_GreenSlime(gamePanel, 11);
        //        gamePanel.getMonsters()[map][11].setWorldX(tileSize * 45);
        //       gamePanel.getMonsters()[map][11].setWorldY(tileSize * 42);
        //         gamePanel.getMonsters()[map][11].setIndex(11);
        //    }
        //  }
